...
public class EnemySpawners : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        Vector2 positionToSpawn = MapGenerator.GetRandomNegativeSpacePointAtDistanceRangeFromPoints(SpatialReasoningCalculator.CurrentInstance.Chunks, StaticLevelDirector.CurrentLevelDirector.GetCharacterPositions(), distanceToSpawnEnemyAt, float.MaxValue, GeometricStampMapGenerationPlan.SUFFICIENTDISTANCEFROMWALLFORROOMLINESS);
